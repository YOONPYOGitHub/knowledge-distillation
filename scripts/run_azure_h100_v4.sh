...
CONFIG="${1:-configs/h100_qwen7b_korean_scale10k_v4.yaml}"
...
student_ft_checkpoint="${paths[1]}"
student_kd_checkpoint="${paths[2]}"
teacher_history="${paths[3]}"
baseline_history="${paths[4]}"
distill_history="${paths[5]}"
